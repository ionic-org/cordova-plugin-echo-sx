...
on [Cordova Plugin Search page](https://cordova.apache.org/plugins/).
...
Application developers use the CLI's [plugin add command](https://cordova.apache.org/docs/en/latest/reference/cordova-cli/index.html#cordova-plugin-command) to add a plugin to a project. The
...
are available in the [Plugin Specification](./spec.md). This abbreviated version of the `Device` plugin provides a simple example to use as a model:
